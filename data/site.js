...
export const mainNav = [
  ...
  { label: 'Plans & pricing', href: '/pricing' },
  {
    ...
    href: '/sectors',
    children: [
      { label: 'Housing associations', href: '/sectors/housing-associations' },
      { label: 'Local authorities', href: '/sectors/local-authorities' },
      { label: 'Build to Rent', href: '/sectors/build-to-rent' },
      { label: 'Private landlords', href: '/sectors/landlords', group: 'Private landlords and agents' },
      { label: 'Letting agents', href: '/sectors/letting-agents', group: 'Private landlords and agents' },
    ],
  },
...
export const footerNav = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Local authorities', href: '/sectors/local-authorities' },
      { label: 'Build to Rent', href: '/sectors/build-to-rent' },
      { label: 'Private landlords', href: '/sectors/landlords' },
      { label: 'Letting agents', href: '/sectors/letting-agents' },
    ],
  },
  {
    heading: 'Residents',
